...
#define SSB_CHIPCO_CHST_4312_SPROM_PRESENT(status)   ((status & SSB_CHIPCO_CHST_4325_SPROM_OTP_SEL) !=   SSB_CHIPCO_CHST_4325_OTP_SEL)
#define SSB_CHIPCO_CHST_4322_SPROM_PRESENT(status)   (status & SSB_CHIPCO_CHST_4322_SPROM_EXISTS)
#define SSB_CHIPCO_CHST_4325_SPROM_PRESENT(status)   (((status & SSB_CHIPCO_CHST_4325_SPROM_OTP_SEL) !=   SSB_CHIPCO_CHST_4325_DEFCIS_SEL) &&   ((status & SSB_CHIPCO_CHST_4325_SPROM_OTP_SEL) !=   SSB_CHIPCO_CHST_4325_OTP_SEL))
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
