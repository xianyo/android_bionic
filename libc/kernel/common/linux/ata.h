...
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
#define ata_id_has_atapi_AN(id)   ((((id)[ATA_ID_SATA_CAPABILITY] != 0x0000) &&   ((id)[ATA_ID_SATA_CAPABILITY] != 0xffff)) &&   ((id)[ATA_ID_FEATURE_SUPP] & (1 << 5)))
#define ata_id_has_fpdma_aa(id)   ((((id)[ATA_ID_SATA_CAPABILITY] != 0x0000) &&   ((id)[ATA_ID_SATA_CAPABILITY] != 0xffff)) &&   ((id)[ATA_ID_FEATURE_SUPP] & (1 << 2)))
