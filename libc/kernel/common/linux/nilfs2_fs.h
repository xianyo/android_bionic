...
#define NILFS_CPINFO_FNS(flag, name)  static inline int  nilfs_cpinfo_##name(const struct nilfs_cpinfo *cpinfo)  {   return !!(cpinfo->ci_flags & (1UL << NILFS_CHECKPOINT_##flag));  }
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
...
#define NILFS_SEGMENT_USAGE_FNS(flag, name)  static inline void  nilfs_segment_usage_set_##name(struct nilfs_segment_usage *su)  {   su->su_flags = cpu_to_le32(le32_to_cpu(su->su_flags) |   (1UL << NILFS_SEGMENT_USAGE_##flag)); }  static inline void  nilfs_segment_usage_clear_##name(struct nilfs_segment_usage *su)  {   su->su_flags =   cpu_to_le32(le32_to_cpu(su->su_flags) &   ~(1UL << NILFS_SEGMENT_USAGE_##flag));  }  static inline int  nilfs_segment_usage_##name(const struct nilfs_segment_usage *su)  {   return !!(le32_to_cpu(su->su_flags) &   (1UL << NILFS_SEGMENT_USAGE_##flag));  }
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
...
#define NILFS_SUINFO_FNS(flag, name)  static inline int  nilfs_suinfo_##name(const struct nilfs_suinfo *si)  {   return si->sui_flags & (1UL << NILFS_SEGMENT_USAGE_##flag);  }
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
enum {
 NILFS_CHECKPOINT,
 NILFS_SNAPSHOT,
