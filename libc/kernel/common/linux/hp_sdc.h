...
#define HP_SDC_XTD_REV_STRINGS(val, str)  switch (val) {   case 0x1: str = "1820-3712"; break;   case 0x2: str = "1820-4379"; break;   case 0x3: str = "1820-4784"; break;   default: str = "unknown";  };
