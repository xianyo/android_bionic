...
#define __get_user_asm_byte(x,addr,err)   __asm__ __volatile__(   "1:	" TUSER(ldrb) "	%1,[%2],#0\n"   "2:\n"   "	.pushsection .fixup,\"ax\"\n"   "	.align	2\n"   "3:	mov	%0, %3\n"   "	mov	%1, #0\n"   "	b	2b\n"   "	.popsection\n"   "	.pushsection __ex_table,\"a\"\n"   "	.align	3\n"   "	.long	1b, 3b\n"   "	.popsection"   : "+r" (err), "=&r" (x)   : "r" (addr), "i" (-EFAULT)   : "cc")
#ifndef __ARMEB__
...
#endif
#define __get_user_asm_word(x,addr,err)   __asm__ __volatile__(   "1:	" TUSER(ldr) "	%1,[%2],#0\n"   "2:\n"   "	.pushsection .fixup,\"ax\"\n"   "	.align	2\n"   "3:	mov	%0, %3\n"   "	mov	%1, #0\n"   "	b	2b\n"   "	.popsection\n"   "	.pushsection __ex_table,\"a\"\n"   "	.align	3\n"   "	.long	1b, 3b\n"   "	.popsection"   : "+r" (err), "=&r" (x)   : "r" (addr), "i" (-EFAULT)   : "cc")
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
...
#define __put_user_err(x,ptr,err)  do {   unsigned long __pu_addr = (unsigned long)(ptr);   __typeof__(*(ptr)) __pu_val = (x);   __chk_user_ptr(ptr);   might_fault();   switch (sizeof(*(ptr))) {   case 1: __put_user_asm_byte(__pu_val,__pu_addr,err); break;   case 2: __put_user_asm_half(__pu_val,__pu_addr,err); break;   case 4: __put_user_asm_word(__pu_val,__pu_addr,err); break;   case 8: __put_user_asm_dword(__pu_val,__pu_addr,err); break;   default: __put_user_bad();   }  } while (0)
#define __put_user_asm_byte(x,__pu_addr,err)   __asm__ __volatile__(   "1:	" TUSER(strb) "	%1,[%2],#0\n"   "2:\n"   "	.pushsection .fixup,\"ax\"\n"   "	.align	2\n"   "3:	mov	%0, %3\n"   "	b	2b\n"   "	.popsection\n"   "	.pushsection __ex_table,\"a\"\n"   "	.align	3\n"   "	.long	1b, 3b\n"   "	.popsection"   : "+r" (err)   : "r" (x), "r" (__pu_addr), "i" (-EFAULT)   : "cc")
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
#ifndef __ARMEB__
...
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
#endif
#define __put_user_asm_word(x,__pu_addr,err)   __asm__ __volatile__(   "1:	" TUSER(str) "	%1,[%2],#0\n"   "2:\n"   "	.pushsection .fixup,\"ax\"\n"   "	.align	2\n"   "3:	mov	%0, %3\n"   "	b	2b\n"   "	.popsection\n"   "	.pushsection __ex_table,\"a\"\n"   "	.align	3\n"   "	.long	1b, 3b\n"   "	.popsection"   : "+r" (err)   : "r" (x), "r" (__pu_addr), "i" (-EFAULT)   : "cc")
#ifndef __ARMEB__
...
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
#endif
#define __put_user_asm_dword(x,__pu_addr,err)   __asm__ __volatile__(   ARM( "1:	" TUSER(str) "	" __reg_oper1 ", [%1], #4\n" )   ARM( "2:	" TUSER(str) "	" __reg_oper0 ", [%1]\n" )   THUMB( "1:	" TUSER(str) "	" __reg_oper1 ", [%1]\n" )   THUMB( "2:	" TUSER(str) "	" __reg_oper0 ", [%1, #4]\n" )   "3:\n"   "	.pushsection .fixup,\"ax\"\n"   "	.align	2\n"   "4:	mov	%0, %3\n"   "	b	3b\n"   "	.popsection\n"   "	.pushsection __ex_table,\"a\"\n"   "	.align	3\n"   "	.long	1b, 4b\n"   "	.long	2b, 4b\n"   "	.popsection"   : "+r" (err), "+r" (__pu_addr)   : "r" (x), "i" (-EFAULT)   : "cc")
